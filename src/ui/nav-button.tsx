...
export default function NavButton({ isOpen, toggle }: NavMobileProps) {
  return (
    <button
      onClick={toggle}
      className="flex flex-col gap-2 w-8 cursor-pointer active:opacity-25 transition relative z-50 md:hidden"
    >
      <div
